...
public class Model1 {
    ...
    @Bind
    private double[] twKI; // growth rate of private consumption
    @Bind
    private double[] twKS; // growth rate of public consumption
    @Bind
    ...
    private double temp; // not associated with the data model or results
